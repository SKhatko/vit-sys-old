...
(function (window, document) {
    ...
    Croppic.prototype = {
        ...
        bindImgUploadControl: function () {
            ...
            var formHtml = '<form class="' + that.id + '_imgUploadForm" style="visibility: hidden;"> <input type="hidden" name="_token" value="' + that.options.csrf_token + '" /> <input type="file" name="img" id="' + that.id + '_imgUploadField">  </form>';
        ...
        crop: function () {
            ...
            if (typeof FormData == 'undefined') {
                ...
                urlEncodedDataPairs.push('_token=' + that.options.csrf_token);
                ...
                formData.append('_token', that.options.csrf_token);
