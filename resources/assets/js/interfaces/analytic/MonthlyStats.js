export default function (options) {
    ...
    $.ajax({
        method: "GET",
        url: '/analytics/ajax/reservations/monthly-data/' + options.months,
    }).done(function (data) {
    ...
    function drawChart(data) {
        ...
        for (var key in data) {
            ...
            /*
             $("#data-table").append('<tr><td>'+key+'</td><td>'+reservationsNum+' / '+personsNum+'</td><td>'+personsPerReservation+'</td><td style="color:green;">'+showed+' ('+showPercent+'%)</td><td style="color:red;">'+noShowed+' ('+noShowPercent+'%)</td><td>'+walkins+' ('+walkinsPercent+'%)</td><td>'+online+' ('+onlinePercent+'%)</td></tr>');
             */
        }
